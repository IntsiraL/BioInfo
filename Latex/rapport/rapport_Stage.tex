...
\begin{titlepage}
  ...
  \begin{center}
    ...
    %\includegraphics[scale=0.1]{./image/ua_v_couleur.jpg}
    \begin{figure}
 \centering
 \includegraphics[scale=0.01]{./image/ua_v_couleur.jpg}
 % ua_v_couleur.jpg: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=
\end{figure}
...
#$
\end{Soutput}
La fonction normexp.fit.control() de limma :
\begin{Sinput}
 normexp.fit.control
\end{Sinput}
\begin{Soutput}
