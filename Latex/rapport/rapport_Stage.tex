...
En examinant la figure 6, on trouve pas des anomalies particuliers sur l’ensemble des contrôles. On voit que les  housekeeping genes produisent des signaux plus fort que les sondes négatives ($12000 > 120$).
L’écart type de l’estimation de la proportion des sondes exprimés sur l’ensemble des échantillons n’est pas énorme ($sd(propexpr(obj))=0.03361209$ de variance $0.001129773$) et donc pas signifiant.
