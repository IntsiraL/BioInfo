...
Par contre, la divergence de ratio trouvée(Figure \ref{fig:pmmm2ratio}) indique une différence possible de stringence d’hybridation entre les échantillons concernés.\\% (problème de spécificité dans l’expérience). \\
